...
public class TodoController {
	...
	@Autowired	// 같은 타입/상속관계 Bean 의존성 주입(DI) 어노테이션
	...
	public String addTodo( @RequestParam("todoTitle") String todoTitle,
		...
		// RedirectAttribute.addFlashAttribute("key", value) 형식으로 작성하면
		// 잠깐 session 에 속성을 추가해줌.
	...
	public String todoDetail( 	@RequestParam("todoNo") int todoNo,
		...
		if(todo != null) {	// 조회 결과 있을 경우
			...
			// forward : classpath:/templates/todo/detail.html
			path = "todo/detail";
